...
public class AddController {
    ...
    public void confirm() {
        ...
        Route newRoute = new Route(name, distance, departureName, departureX,departureY,departureZ, destinationName, destinationX, destinationY, destinationZ, creationDate);
